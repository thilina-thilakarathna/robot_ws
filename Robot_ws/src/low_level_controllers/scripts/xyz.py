...
class Ui_Form(object):
    def __init__(self):
        print("initializing")
        self.pub = rospy.Publisher('/abc',tip, queue_size=10)
    def publish_msg(self):
        self.pub.publish(self.x_l.value(),0,0,0,0,0)
    def left_x(self):
        print("leftx")
        print(self.x_l.value(),0,0,0,0,0)
        self.pub.publish(self.x_l.value(),0,0,0,0,0)
    def left_y(self):
        print("lefty")
    def left_z(self):
    ...
    def setupUi(self, Form):
        ...
        self.r1.clicked['bool'].connect(self.mirror_val)
...
if __name__ == "__main__":
    import sys
    rospy.init_node('xyz1', anonymous=True)
