...
class Sfl_Light_Hs {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Light_Hs(null);
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Light_Hs';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '96545159ca8fb06ca8dd4b56ba6cb941';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Light_Hs(null);
