...
class AirAdvisor_Hive_Position {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AirAdvisor_Hive_Position(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AirAdvisor_Hive_Position(null);
...
module.exports = AirAdvisor_Hive_Position;
