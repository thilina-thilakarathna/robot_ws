...
class Sfl_Light_V {
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Light_V';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4bcabff6ed6a446b56f37c964936f846';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Light_V(null);
