...
class Sfl_Sunflower {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Sunflower(null);
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Sunflower';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '50d7cc15344a376ced38f3d0121b6406';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Sunflower(null);
