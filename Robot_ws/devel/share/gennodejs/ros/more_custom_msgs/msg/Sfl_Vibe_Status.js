...
class Sfl_Vibe_Status {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.cadence, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Vibe_Status(null);
    ...
    data.cadence = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Vibe_Status(null);
...
module.exports = Sfl_Vibe_Status;
