...
class Sfl_Light_Theme {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Light_Theme(null);
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Light_Theme';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '81e0b44d77aed1acb42245500add5cdc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Light_Theme(null);
...
module.exports = Sfl_Light_Theme;
