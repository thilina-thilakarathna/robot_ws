...
class Sfl_Single_Value {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Single_Value(null);
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Single_Value';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '0f5b844bbba36096594b40746a29f66c';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Single_Value(null);
...
module.exports = Sfl_Single_Value;
