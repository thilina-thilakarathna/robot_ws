...
class Sfl_Light_Power {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sfl_Light_Power(null);
  ...
  static datatype() {
    ...
    return 'more_custom_msgs/Sfl_Light_Power';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '84fd70159226d3d764ac24eabec7d0c1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sfl_Light_Power(null);
...
module.exports = Sfl_Light_Power;
