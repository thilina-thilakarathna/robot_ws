...
(cl:defclass <Sfl_Light_Theme> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Sfl_Light_Theme (<Sfl_Light_Theme>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Sfl_Light_Theme>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Sfl_Light_Theme)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name more_custom_msgs-msg:<Sfl_Light_Theme> is deprecated: use more_custom_msgs-msg:Sfl_Light_Theme instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Sfl_Light_Theme>))
...
(cl:defmethod serialnumber-val ((m <Sfl_Light_Theme>))
...
(cl:defmethod hue-val ((m <Sfl_Light_Theme>))
...
(cl:defmethod saturation-val ((m <Sfl_Light_Theme>))
...
(cl:defmethod fadetime-val ((m <Sfl_Light_Theme>))
  ...
  (fadetime m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Sfl_Light_Theme>) ostream)
  "Serializes a message object of type '<Sfl_Light_Theme>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Sfl_Light_Theme>) istream)
  "Deserializes a message object of type '<Sfl_Light_Theme>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sfl_Light_Theme>)))
  "Returns string type for a message object of type '<Sfl_Light_Theme>"
  "more_custom_msgs/Sfl_Light_Theme")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sfl_Light_Theme)))
  "Returns string type for a message object of type 'Sfl_Light_Theme"
  "more_custom_msgs/Sfl_Light_Theme")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sfl_Light_Theme>)))
  "Returns md5sum for a message object of type '<Sfl_Light_Theme>"
  "81e0b44d77aed1acb42245500add5cdc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sfl_Light_Theme)))
  "Returns md5sum for a message object of type 'Sfl_Light_Theme"
  "81e0b44d77aed1acb42245500add5cdc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sfl_Light_Theme>)))
  "Returns full string definition for message of type '<Sfl_Light_Theme>"
  (cl:format cl:nil "std_msgs/Header header~%uint32           serialnumber~%uint16           hue~%uint8            saturation~%uint16           fadetime~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sfl_Light_Theme)))
  "Returns full string definition for message of type 'Sfl_Light_Theme"
  (cl:format cl:nil "std_msgs/Header header~%uint32           serialnumber~%uint16           hue~%uint8            saturation~%uint16           fadetime~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Sfl_Light_Theme>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Sfl_Light_Theme>))
  "Converts a ROS message object to a list"
  (cl:list 'Sfl_Light_Theme
