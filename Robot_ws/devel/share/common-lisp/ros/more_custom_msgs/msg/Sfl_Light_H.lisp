...
(cl:defclass <Sfl_Light_H> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Sfl_Light_H (<Sfl_Light_H>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Sfl_Light_H>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Sfl_Light_H)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name more_custom_msgs-msg:<Sfl_Light_H> is deprecated: use more_custom_msgs-msg:Sfl_Light_H instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Sfl_Light_H>))
...
(cl:defmethod serialnumber-val ((m <Sfl_Light_H>))
...
(cl:defmethod hue-val ((m <Sfl_Light_H>))
  ...
  (hue m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Sfl_Light_H>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Sfl_Light_H>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sfl_Light_H>)))
  "Returns string type for a message object of type '<Sfl_Light_H>"
  "more_custom_msgs/Sfl_Light_H")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sfl_Light_H)))
  "Returns string type for a message object of type 'Sfl_Light_H"
  "more_custom_msgs/Sfl_Light_H")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sfl_Light_H>)))
  "Returns md5sum for a message object of type '<Sfl_Light_H>"
  "99f2ed26b620022c4b382b051557e911")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sfl_Light_H)))
  "Returns md5sum for a message object of type 'Sfl_Light_H"
  "99f2ed26b620022c4b382b051557e911")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sfl_Light_H>)))
  "Returns full string definition for message of type '<Sfl_Light_H>"
  (cl:format cl:nil "std_msgs/Header header~%uint32           serialnumber~%uint16           hue~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sfl_Light_H)))
  "Returns full string definition for message of type 'Sfl_Light_H"
  (cl:format cl:nil "std_msgs/Header header~%uint32           serialnumber~%uint16           hue~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Sfl_Light_H>))
  (cl:+ 0
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'header))
     4
     2
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Sfl_Light_H>))
