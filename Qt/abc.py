...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.x_l.valueChanged['int'].connect(Form.left_x)
        self.y_l.valueChanged['int'].connect(Form.left_y)
        self.z_l.valueChanged['int'].connect(Form.left_z)
        self.x_r.valueChanged['int'].connect(Form.right_x)
        self.y_r.valueChanged['int'].connect(Form.right_y)
        self.z_r.valueChanged['int'].connect(Form.right_z)
        self.r1.clicked['bool'].connect(Form.mirror_val)
