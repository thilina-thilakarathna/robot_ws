...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        QtCore.QObject.connect(self.horizontalSlider, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.rightCoxa)
        QtCore.QObject.connect(self.horizontalSlider_2, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.rightFemur)
        QtCore.QObject.connect(self.horizontalSlider_3, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.rightTibia)
        QtCore.QObject.connect(self.horizontalSlider_4, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.leftCoxa)
        QtCore.QObject.connect(self.horizontalSlider_5, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.leftFemur)
        QtCore.QObject.connect(self.horizontalSlider_6, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.LeftTibia)
        QtCore.QObject.connect(self.horizontalSlider_7, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.frontRight)
        QtCore.QObject.connect(self.horizontalSlider_8, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.frontLeft)
        QtCore.QObject.connect(self.horizontalSlider_9, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), Form.backWheel)
